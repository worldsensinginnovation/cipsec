/*!
 * \file wb_jammer_detector_cc.h
 * \brief This class implements an algorithm to detect wide band jammers
 *
 *  Wide Band Noise Jammer Detection strategy
 *  <ol>
 *  <li> Estimate the initial noise floor power
 *  <li> Calculate Power of incoming signal
 *  <li> Compare Statistic (Power) with threshold
...
#ifndef WB_JAMMER_DETECTOR_CC_H
#define WB_JAMMER_DETECTOR_CC_H
...
class wb_jammer_detector_cc;

typedef boost::shared_ptr<wb_jammer_detector_cc> wb_jammer_detector_cc_sptr;

wb_jammer_detector_cc_sptr
wb_jammer_make_detector_cc(long fs_in_hz,
...
/*!
 * \brief This class implements a wb Jammer Detection algorithm.
 *
 */
class wb_jammer_detector_cc: public gr::block
{
private:
    friend wb_jammer_detector_cc_sptr
    wb_jammer_make_detector_cc(long fs_in_hz,
                                   unsigned int block_samples,
                                   unsigned int noise_estimations,
                                   unsigned int A,
    ...
    wb_jammer_detector_cc(long fs_in_hz,
                              unsigned int block_samples,
                              unsigned int noise_estimations,
                              unsigned int A,
                              unsigned int B,
...
public:
    ...
    /*!
     * \brief wb Jammer Detector signal processing.
     */
