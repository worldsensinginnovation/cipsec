/*!
 * \file lfm_jammer_detector_cc.h
 * \brief This class implements an algorithm to detect chirp jammers
 *
 *  
 *  Linear FM (chirp) Jammer Detection strategy
 *  <ol>
 ...
 *  <li> Extract relative frequency of positive samples between minimums 
...
#ifndef LFM_JAMMER_DETECTOR_CC_H
#define LFM_JAMMER_DETECTOR_CC_H
...
class lfm_jammer_detector_cc;

typedef boost::shared_ptr<lfm_jammer_detector_cc> lfm_jammer_detector_cc_sptr;

lfm_jammer_detector_cc_sptr
lfm_jammer_make_detector_cc(long fs_in_hz,
...
/*!
 * \brief This class implements a Linear FM Jammer Detection algorithm.
 *
 */
class lfm_jammer_detector_cc: public gr::block
{
private:
    friend lfm_jammer_detector_cc_sptr
    lfm_jammer_make_detector_cc(long fs_in_hz,
                                   unsigned int block_samples,
                                   unsigned int fft_samples,
                                   unsigned int noise_estimations,
    ...
    lfm_jammer_detector_cc(long fs_in,
                              unsigned int block_samples,
                              unsigned int fft_samples,
                              unsigned int noise_estimations,
                              unsigned int A,
    ...
    float* d_inst_freq_est;
    float* d_diff_inst_freq_est;
    float* d_diff_inst_freq_est_neg;
    float d_mean;
    float d_input_power;
...
public:
    ...
    /*!
     * \brief Linear FM Jammer Detector signal processing.
     */
...
#endif /* LFM_JAMMER_DETECTOR_CC_H*/
