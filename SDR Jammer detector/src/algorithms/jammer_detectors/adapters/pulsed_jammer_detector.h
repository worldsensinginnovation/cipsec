...
#ifndef PULSED_JAMMER_DETECTOR_H_
#define PULSED_JAMMER_DETECTOR_H_
...
/*!
 * \brief This class adapts a Pulsed Jammer Detector block to
 *  a JammerDetectorInterface
 */

class PulsedJammerDetector: public JammerDetectorInterface
{
public:
    PulsedJammerDetector(ConfigurationInterface* configuration,
            std::string role, unsigned int in_streams,
            unsigned int out_streams);

    virtual ~PulsedJammerDetector();
    ...
    /*!
     * \brief Returns "Pulsed_Jammer_Detector"
     */
    std::string implementation()
    {
        return "Pulsed_Jammer_Detector";
    }
    size_t item_size()
    {
        return item_size_;
...
private:
    ...
    pulsed_jammer_detector_cc_sptr detector_cc_;
...
#endif /* PULSED_JAMMER_DETECTOR_H_ */
