#!/usr/bin/python
# 2019/01/10 Cuando se usa seudonymization, hash del campo ORGANIZATION
...
def anon(policies_file, event):
	...
	print("SSSSSSSSSCCCCCCCOOOOOOOPPPPPPPPPEEEEE")
	print(scope)
	print("OOOOOOOOORRRRRRRRRRRRGGGGGGGGGGGG")
	print(event.get('ORGANIZATION', ''))
