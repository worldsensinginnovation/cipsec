...
#ifndef WB_JAMMER_DETECTOR_H_
#define WB_JAMMER_DETECTOR_H_

#include <string>
#include <gnuradio/blocks/stream_to_vector.h>
#include <gnuradio/blocks/float_to_complex.h>
#include "jammer_detector_interface.h"
#include "wb_jammer_detector_cc.h"
...
/*!
 * \brief This class adapts a WB Jammer Detector block to
 *  a JammerDetectorInterface
 */

class WBJammerDetector: public JammerDetectorInterface
{
public:
    WBJammerDetector(ConfigurationInterface* configuration,
            std::string role, unsigned int in_streams,
            unsigned int out_streams);

    virtual ~WBJammerDetector();
    ...
    /*!
     * \brief Returns "WB_Jammer_Detector"
     */
    std::string implementation()
    {
        return "WB_Jammer_Detector";
    }
    size_t item_size()
    {
        return item_size_;
...
private:
    ...
    wb_jammer_detector_cc_sptr detector_cc_;
